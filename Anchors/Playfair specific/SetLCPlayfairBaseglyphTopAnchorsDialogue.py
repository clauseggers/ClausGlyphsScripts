#MenuTitle: Interactively set top anchors in base glyphs
#Created by Claus
# -*- coding: utf-8 -*-
__doc__="""
Interactively set a vertical array of diacritic top anchors using the existing top anchor for alignment.
"""
