#MenuTitle: Enable automatic alignment of all components in all layers
#Created by Claus
# -*- coding: utf-8 -*-
__doc__="""
Enables automatic alignment of all components in all layers.
"""
